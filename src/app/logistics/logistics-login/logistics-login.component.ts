...
@Component({
  selector: 'app-logistics-login',
  templateUrl: './logistics-login.component.html',
  styleUrls: ['./logistics-login.component.css']
})
export class LogisticsLoginComponent implements OnInit {
